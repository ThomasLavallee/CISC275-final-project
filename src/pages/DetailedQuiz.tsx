...
export function DetailedQuiz({validAPI, setAppAnswers}: DetailedQuizProps): React.JSX.Element {
    ...
    const DetailedOptions = [
        ["","A structured office setting with clear guidelines", "A flexible, creative space where I can innovate", "Outdoors or in a hands-on setting","A fast-paced, high-energy environment"], 
        ["","Stability and financial security", "Creativity and self-expression", "Making a tangible impact on people’s lives","Excitement and new challenges"],
        ["","Making cool things like art, videos, coding, or building stuff","Figuring things out by solving problems, learning how things work, and diving into details","Helping people by giving advice, being there for others, or making someone’s day better","Taking charge by planning, organizing, or getting people together to make things happen"],
        ["","Math and science","Art, music, or literature","Physical education or shop class","Social studies or business"],
        ["","A structured 9-to-5 schedule","A flexible schedule where I set my own hours","A mix of physical activity and desk work","A high-energy job with varying hours"],
        ["","The planner who organizes and sets deadlines","The creative mind who comes up with fresh ideas","The hands-on worker who gets things done","The leader who motivates and manages the team"],
        ["","I prefer to communicate through writing or data","I don’t mind it if I can be creative with my presentation","I’d rather avoid it and focus on hands-on work","I love speaking in front of groups and sharing ideas"],
        ["","Spreadsheets, data analytics, or coding software","Sketchbooks, cameras, or musical instruments","Tools, machinery, or physical equipment","Microphones, business plans, or networking apps"],
        ["","Clear and structured with clear expectations","Encouraging and open to new ideas","Hands-off, letting me work independently","Inspiring and energetic, pushing me to succeed"],
        ["","Solving a complex puzzle or coding a program","Creating an artistic design or writing a story","Building or fixing something with my hands","Leading a project or managing a team"],
    ...
    return <div className="Detailed-Quiz-Page">
        ...
        <div className="Detailed-Progress-Bar-Wrapper">
            <div className="Detailed-Progress-Bar-Border">
                <div style={{ width: `${Math.floor((questionNumber/DetailedQuestions.length) * 100)}%` }} className="Detailed-Progress-Bar">{Math.floor((questionNumber/DetailedQuestions.length) * 100)}%</div>
            </div>
        </div>
